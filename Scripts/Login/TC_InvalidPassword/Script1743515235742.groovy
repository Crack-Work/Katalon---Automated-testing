...
WebUI.verifyElementText(findTestObject('Authentication/Login/h2_hai, kasirAja'), 'hai, kasir aja')
...
WebUI.setText(findTestObject('Authentication/Login/input_email_email'), 'kevin@laminion.com')

WebUI.setEncryptedText(findTestObject('Authentication/Login/input_password_password'), 'BR4+6ebIRw/89ruX5hJDag==')
